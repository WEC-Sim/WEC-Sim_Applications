...
def oc4(draft, meshFile, directory):
    """
    This function calculates the hydrostatics for the OC4 given: 
    different drafts, mesh files, and directories.
    
    Saves the Capytaine output and hydrostatic information to the specified directory
...
def write_hydrostatics(directory, khs,cg,cb,volume):
