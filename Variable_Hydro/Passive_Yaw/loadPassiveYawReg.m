...
load('..\..\Passive_Yaw\PassiveYawRegression\RegYaw_org.mat') % Load Previous WEC-Sim Data
...
subplot(1,2,2)
plot(RegYaw.time_new,RegYaw.Force_new,':k','LineWidth',1.4)
hold on;
grid on;
plot(RegYaw.time_org,RegYaw.Force_org,'-k')
xlabel('Time(s)');
