...
body(1).morrisonElement.cd = [0 0 1];
body(1).morrisonElement.ca = [0 0 1];
body(1).morrisonElement.characteristicArea = [0 0 1];
body(1).morrisonElement.VME = [0.01];
body(1).morrisonElement.rgME = [0 0 -2];
