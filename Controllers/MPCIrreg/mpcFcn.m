...
% by mpcStruct is just control action, we set sizeForSlack == no.
if mpcStruct.modelPredictiveControl.expandSlack == 1 || mpcStruct.modelPredictiveControl.slack == 1 % useSlackYN is here just in case sizeforslack is accidentally left set to no
%     WuScale = mpcStruct.WuScale;
%     WyScale = mpcStruct.WyScale;
%     
%     uSlackLength = (mpcStruct.HpInK+1)*wec.numWECs; 
%     ySlackLength = wec.yLen*mpcStruct.HpInK*wec.numWECs; 
%     
%     if strcmp(mpcStruct.useSlackYN,'yes') == 1
%     %% Slack on U and Y
%     H = [...
...
%         ];
% 
%     elseif strcmp(mpcStruct.useSlackYN,'no') == 1
...
% if strcmp(mpcStruct.sizeForSlack,'yes') == 1 || strcmp(mpcStruct.useSlackYN,'yes') == 1
%     if strcmp(mpcStruct.useSlackYN,'yes') == 1
%         
