...
% controller(1).MPC = 1;
% controller(1).modelPredictiveControl.maxPTOForce = 5e6;
% controller(1).modelPredictiveControl.maxPTOForceChange = 3e6;
...
% controller(1).modelPredictiveControl.dt = .4;
% controller(1).modelPredictiveControl.rScale = .5e-7;
% controller(1).modelPredictiveControl.predictionHorizon = 10;
