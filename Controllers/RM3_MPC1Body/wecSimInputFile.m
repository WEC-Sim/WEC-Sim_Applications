...
controller(1).MPC = 1;
controller(1).modelPredictiveControl.maxPTOForce = 3e6;
controller(1).modelPredictiveControl.maxPTOForceChange = 2e6;
controller(1).modelPredictiveControl.maxPos = 1.5;
controller(1).modelPredictiveControl.maxVel = 1;
