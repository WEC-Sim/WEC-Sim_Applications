...
load('Properties_10MW');

%% Blade
bladefile=importdata(['BladeData' filesep '10MW' filesep 'IEA-10.0-198-RWT_AeroDyn15_blade.dat'],' ',6);
...
airfoilfile=importdata(['BladeData' filesep '10MW' filesep 'IEA-10.0-198-RWT_AeroDyn15_Polar_' num2str(i-1) '.dat'],' ',54);
...
%% Save
save('Bladedata_10MW.mat','bladedata')
