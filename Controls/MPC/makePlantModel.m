...
%
% plant.A = [0, -wec.k/(wec.m+wec.Ainf), 1/(wec.m+wec.Ainf), 0; ...
%      1, 0, 0, 0; ...
%      -wec.Caa/wec.Cba, -wec.Cab/wec.Cba, -wec.Cbb/wec.Cba, -wec.Cbc/wec.Cba; ...
%      0, 0, 1, 0];
%  
% plant.Bu = [1/(wec.m+wec.Ainf);  %dZb
%        0;   % Zb
%        0;   % Fr
%        0];  % intFr
%    
% plant.Bv = [1/(wec.m+wec.Ainf);  ...
%        0;  ...
%        0;  ...
%        0];
% 
% plant.C = [1 0 0 0; ... % Map y(1) = dZb
%          0 1 0 0; ... % Map y(2) = Zb
%         ];
...
controller(1).plant.Bu(1,1) = 1/(controller(1).bemData.m+controller(1).bemData.aInf);
