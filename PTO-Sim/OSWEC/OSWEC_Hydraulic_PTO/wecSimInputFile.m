...
ptoSim(1).ptoSimType = 7;
ptoSim(1).adjustableRod.crank = 3;
ptoSim(1).adjustableRod.offset = 1.3;
ptoSim(1).adjustableRod.rodInit = 5;

%Hydraulic Cylinder
ptoSim(2) = ptoSimClass('PTOSim2');
ptoSim(2).ptoSimNum  = 2;
ptoSim(2).ptoSimType = 2;
